...
class MqttGatewayClientFactory extends pip_services_components_node_1.Factory {
    constructor() {
        super();
...
MqttGatewayClientFactory.Descriptor = new pip_services_commons_node_1.Descriptor('iqs-services-mqttgateway', 'factory', 'default', 'default', '1.0');
MqttGatewayClientFactory.NullClientV1Descriptor = new pip_services_commons_node_1.Descriptor('iqs-services-mqttgateway', 'client', 'null', 'default', '1.0');
MqttGatewayClientFactory.DirectClientV1Descriptor = new pip_services_commons_node_1.Descriptor('iqs-services-mqttgateway', 'client', 'direct', 'default', '1.0');
MqttGatewayClientFactory.HttpClientV1Descriptor = new pip_services_commons_node_1.Descriptor('iqs-services-mqttgateway', 'client', 'http', 'default', '1.0');
MqttGatewayClientFactory.LambdaClientV1Descriptor = new pip_services_commons_node_1.Descriptor('iqs-services-mqttgateway', 'client', 'lambda', 'default', '1.0');
